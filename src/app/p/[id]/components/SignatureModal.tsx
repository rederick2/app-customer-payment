  ...
  return (
    <Dialog open={isOpen} onOpenChange={(val) => { if (!val && !isLoading) onClose(); }}>
      <DialogContent className="sm:max-w-md p-6">
        <DialogHeader>
          <DialogTitle className="text-xl font-serif">Firma Requerida</DialogTitle>
          <DialogDescription>
            Por favor, registre su firma a continuación para aprobar formalmente la cotización.
          </DialogDescription>
        </DialogHeader>
          ...
          {activeTab === 'draw' && (
            <div className="mt-4">
              ...
              <p className="text-xs text-muted-foreground mt-3 text-center">
                Utilice el mouse o su dedo para firmar dentro del recuadro.
              </p>
            </div>
          )}
            ...
            <div className="mt-4">
              <div className="space-y-4 py-8">
                ...
                <p className="text-xs text-muted-foreground mt-2 text-center">
                  Su nombre reemplazará a la firma en el documento PDF final.
                </p>
              </div>
            </div>
          )}
