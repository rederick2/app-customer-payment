    ...
    <div className="flex bg-[#F4F2EC] min-h-screen">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-[#E2E0D8] bg-[#EFECE5] h-screen sticky top-0 px-4 py-8">
        ...
        <nav className="flex-1 space-y-1">
          ...
          {/* <Link href="#" className="flex items-center px-3 py-3 text-sm font-medium text-[#0D3B47] rounded-md hover:bg-black/5 transition-colors">
            <Calendar className="mr-3 h-5 w-5 text-[#0D3B47]" />
            Appointments
          </Link>
          <Link href="#" className="flex items-center px-3 py-3 text-sm font-medium text-[#0D3B47] rounded-md hover:bg-black/5 transition-colors">
