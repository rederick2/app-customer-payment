    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Bienvenido al panel de control de EstudioPro.</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
        <Card className="shadow-sm border-border/50 bg-card/50 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Emitidas hasta la fecha</p>
          </CardContent>
        </Card>
        <Card className="shadow-sm border-border/50 bg-card/50 backdrop-blur-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">En tu cartera</p>
          </CardContent>
        </Card>
      </div>

      <h2 className="font-serif text-2xl font-semibold tracking-tight mb-4">Proformas Recientes</h2>
          ...
          {recentProformas && recentProformas.length > 0 ? (
            <table className="w-full text-sm text-left">
              <thead className="text-xs uppercase bg-muted/50 text-muted-foreground">
                <tr>
                  <th scope="col" className="px-6 py-4 font-medium">Proyecto</th>
            ...
            <div className="p-8 text-center text-muted-foreground flex flex-col items-center">
              ...
              <p>No tienes proformas recientes.</p>
