                ...
                <table className="w-full text-sm text-left">
                  <thead className="text-xs uppercase bg-muted/40 text-muted-foreground">
                    <tr>
                      ...
                      <th className="px-5 py-3.5 text-right font-medium">Date</th>
                    </tr>
                  </thead>
                    ...
                    {recentProformas.map((p) => (
                      <tr key={p.id} className="bg-card hover:bg-muted/20 transition-colors">
                        <td className="px-5 py-3.5">
                          <Link href={`/proforma/${p.id}`} className="font-medium text-foreground hover:text-primary transition-colors">
                            {p.project_name}
                          </Link>
                        </td>
                        <td className="px-5 py-3.5 text-muted-foreground">{(p.clients as any)?.name || '—'}</td>
