...
import { LayoutDashboard, Users, PlusCircle, ListTodo, LogOut, MessageSquare, Calendar, Settings, GanttChart, FileText, Briefcase, Receipt, Camera } from 'lucide-react';
            ...
            <>
              <aside className="hidden md:flex flex-col w-64 border-r border-border/40 bg-muted/20 h-screen sticky top-0 px-4 py-8 print:hidden">
                ...
                <nav className="flex-1 space-y-2">
                  ...
                  <Link href="/gallery" className="flex items-center px-3 py-2.5 text-sm font-medium text-foreground/80 hover:text-primary hover:bg-muted/50 rounded-md transition-colors">
              ...
              <div className="hidden md:block fixed top-0 left-64 right-0 z-40 print:hidden">
                <TopBar userProfile={userProfile} unreadCount={unreadCount} />
              </div>
